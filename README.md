...
## OSINT / Cyber Threat Intelligence (OSINT)
> 
...
### Outils
- :gb:[Exegol](https://exegol.com/) : Une suite d'outils de pentesting qui peut s'intégrer à votre OS. Basé sur pipx. Les outils sont indépendants (containerisés) et fonctionnels en permanence. Edité par des français :rooster:
