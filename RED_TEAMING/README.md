# Cybersecurity Curated readings & Resources
## :pirate_flag: Red Teaming et Hacking

### :newspaper: Informations et Actualités
...
- :gb: [Commando VM](https://github.com/mandiant/commando-vm) : Edité par Mandiant (Google), Commando VM est une distribution spécialisée "sécurité Windows". Elle s'installe sous Windows également.
...
- :gb: [Kali](https://www.kali.org/) : Kali linux security... On ne présente plus cette distribution :blush: